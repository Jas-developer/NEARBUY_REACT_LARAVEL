...
export const Footer = () => {
  return (
    <div className="footer-wrapper mt-2 bg-orange-400 text-white">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-8 md:mx-12 lg:mx-24">
        ...
        <div className="grid bg-orange-400 mt-2 text-white">
          ...
          <p>To be the leading online marketplace, connecting buyers and sellers in a seamless and vibrant shopping experience.</p>
        </div>
        <div className="grid bg-orange-400 mt-2 text-white">
