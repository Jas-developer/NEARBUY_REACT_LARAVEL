                ...
                <nav className="bg-orange-400 flex justify-between p-5 text-white">
                    ...
                    <div>
                        <ul className="hidden md:flex space-x-12 ">
                            <li><Link to="/" className="hover:text-gray-200 align-middle">Home</Link></li>
                            <li><Link to="/help" className="hover:text-gray-200 align-middle">Help</Link></li>
                            <li><Link to="/service" className="hover:text-gray-200 align-middle">Service</Link></li>
                            <li><Link to="/store" className="hover:text-gray-200 align-middle">Find a store</Link></li>                      
                            <li><Link to="/contact" className="hover:text-gray-200 align-middle">Contact</Link></li>
                            <li><button className="p-2 rounded bg-blue-400">Sign Up</button></li>                    
                        </ul>
