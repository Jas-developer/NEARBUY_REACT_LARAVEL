...
<main class="flex w-full h-full shadow-lg rounded-3xl">
    <section class="flex flex-col pt-3 w-4/12 bg-gray-50 h-full overflow-y-scroll">
      ...
      <ul class="mt-6">
        <li class="py-5 border-b px-3 transition hover:bg-orange-100">
          <a href="#" class="flex justify-between items-center">
            <h3 class="text-lg font-semibold">John Doe</h3>
            <p class="text-md text-gray-400">23m ago</p>
          </a>
          <div class="text-md italic text-gray-400">Successfully made a purchase!</div>
        </li>
        <li class="py-5 border-b px-3 transition hover:bg-orange-100">
          <a href="#" class="flex justify-between items-center">
            <h3 class="text-lg font-semibold">John Doe</h3>
        ...
        <li class="py-5 border-b px-3 bg-orange-400 text-white">
          <a href="#" class="flex justify-between items-center">
            <h3 class="text-lg font-semibold">John Doe</h3>
            <p class="text-md">23m ago</p>
          </a>
          <div class="text-md">Successfully made a purchase!</div>
        </li>
        <li class="py-5 border-b px-3 transition hover:bg-orange-100">
          <a href="#" class="flex justify-between items-center">
            <h3 class="text-lg font-semibold">John Doe</h3>
    ...
    <section class="w-6/12 px-4 flex flex-col bg-white rounded-r-3xl">
      <div class="flex justify-between items-center h-48 border-b-2 mb-8">
        <div class="flex space-x-4 items-center">
          ...
          <div class="flex flex-col">
            ...
            <p class="text-light text-gray-400">john.doe@gmail.com</p>
          </div>
        </div>
        <div>
      ...
      <section class="mt-6 border rounded-xl bg-gray-50 mb-3">
        ...
        <div class="flex items-center justify-between p-2">
          ...
          <button class="bg-blue-600 text-white px-6 py-2 rounded-xl">Reply</button>
        </div>
      </section>
    </section>
  </main> 
